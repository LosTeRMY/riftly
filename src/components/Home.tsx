    ...
    <main className="h-screen w-full flex flex-col items-center justify-center px-8 relative overflow-hidden">
      ...
      <div className="w-full max-w-3xl flex flex-col items-center relative z-10">
        ...
        <div className="glow-effect w-full flex items-center gap-2 p-2 bg-surface-container-low border border-outline-variant/30 rounded-xl transition-shadow duration-500">
          ...
          {/* Search button */}
          <button onClick={handleSearch} className="shrink-0 bg-primary-container text-on-primary-container font-label font-bold text-sm tracking-wider uppercase py-4 px-8 rounded-lg border-none cursor-pointer flex items-center gap-2 shadow-[0_0_20px_rgba(0,255,148,0.2)] transition-colors duration-150 whitespace-nowrap hover:bg-primary">
            Search
